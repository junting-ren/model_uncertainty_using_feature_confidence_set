...
file_name = 'sim_results_Ridge_true_contour_second_stage_boot_smoothed'+date+'.csv'
if __name__ ==  '__main__': 
    ...
    for param in param_grid:
        ...
        df_ = pd.DataFrame(np.array(pool_obj.starmap(linear_sim_func.sim_linear,cur_para)), 
