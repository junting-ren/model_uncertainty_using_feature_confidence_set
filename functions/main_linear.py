...
file_name = 'sim_results_ridge_test'+date+'.csv'
if __name__ ==  '__main__': 
    ...
    param_grid = {'N': N_v, 'N_test': N_test_v, 'p': p_v , 'error_sd': error_sd_v, 'L': L_v,
                  ...
                  'ridge_penal':ridge_penal_v, 'MC':MC_v, 'smoothed':smoothed_v, 'residual_boot':residual_boot_v, 'CV_boot':CV_boot_v}
    ...
    for param in param_grid:
        ...
        cur_para = (n_sim*((param['N'], param['N_test'], param['p'], param['error_sd'], \
                          param['L'],param['level'],param['use_true_contour'], param['n_boot'], 
                            param['ridge_penal'], param['MC'], param['smoothed'], param['residual_boot'], param['CV_boot']),))
